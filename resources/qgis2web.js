...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-377247.743800, 7527626.909388, -349877.337200, 7557432.493921], maxZoom: 23, minZoom: 6
    })
});


map.getView().fit([-377247.743800, 7527626.909388, -349877.337200, 7557432.493921], map.getSize());
